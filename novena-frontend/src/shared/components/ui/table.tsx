...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-12 px-4 text-left align-middle font-semibold text-xs text-gray-700 uppercase tracking-wider bg-gray-50 [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn('p-4 align-middle text-sm text-gray-800 [&:has([role=checkbox])]:pr-0', className)}
    {...props}
  />
));
